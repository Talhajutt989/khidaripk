...
const HERO_SLIDES = [
  {
    id: 1,
    tag: '⚡ KHARIDARI 2.0 — Pakistan’s Premier Marketplace',
    title: 'پاکستان کا سب سے جدید',
    highlight: 'آن لائن بازار',
    subtitle: 'Lahore, Karachi, Islamabad — 24-48 گھنٹوں میں Express Delivery aur Verified Sellers',
  ...
  {
    id: 2,
    tag: '🛡️ CNIC & KYC VERIFIED STORES',
    title: 'Verified Vendors سے',
    highlight: '100% محفوظ خریداری',
    subtitle: '7 days easy returns guarantee, Escrow payment protection aur live order tracking',
    cta: 'Verified Stores دیکھیں',
    ctaHref: '/stores',
    bg: 'from-sky-600 via-blue-600 to-indigo-600',
    image: 'https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=1000&auto=format&fit=crop&q=80',
  },
  {
    id: 3,
    tag: '🚀 BECOME A VERIFIED SELLER',
    title: 'اپنا Online Store',
    highlight: 'آج ہی رجسٹر کریں',
    subtitle: '5 mint mein shop banayein, CNIC verify karayein aur pooray Pakistan mein saaman bechein',
    cta: 'Seller Portal Kholain',
    ctaHref: '/vendor',
    bg: 'from-emerald-600 via-teal-600 to-green-600',
